...
const Products = ({ products, SHOP_ADDRESS, mandalaImages }) => (
  <div className="container container--pad-top">
    ...
    <p className="light-green">All the mandala images are created by hand. </p>
    <p className="light-green">All mandala cards are 4 ½ by 6 inches when folded, or 9 x 6 inches when open. Mandala art is on the front side of the card, and the mandala title and a message is on the back of the card. The insides are left blank for you to write in, as you like. </p>
    ...
    <p className="light-green" style={{ marginBottom: "2rem", textDecoration: "underline", fontSize: "1.1em" }}><b>A minimum purchase of $20 is required. All packages have a $5 shipping and handling fee.
</b></p>
